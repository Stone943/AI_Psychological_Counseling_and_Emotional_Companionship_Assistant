...
4. **tests/ 目录测试未达方案要求** — 当前本地基线 213 tests，仍缺 MySQL/A/C/内容/Android/ECS 门禁测试
5. **content/ 目录为空** — 24 个内容制品需要外部内容作者交付
6. **全仓 mypy 尚未清零** — 当前宽范围检查仍有 67 个旧骨架/未类型化模块错误；本轮功能变更模块的定向 mypy 通过
...
| **测试** | 213 tests (本地单元+契约+API+对抗) | 方案其余测试与全部外部环境门禁 |
